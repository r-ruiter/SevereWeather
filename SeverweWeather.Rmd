...
```{r plot1, fig.cap="*Fig 1. Damage per Event Type*", fig.height=5, fig.width=8}
...
```{r plot2, fig.cap="*Fig 2. Fatalities and Injuries per Event Type*", fig.height=5, fig.width=8}
